...
# new list containing only the values from the original list that are greater than 
# its 2nd value. Print how many values this is and then return the new list. If the 
